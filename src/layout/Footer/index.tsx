    ...
    <div className="max-sm:px-4">
      <Container>
        <div className="bg-card-linear rounded-lg">
          <div className="px-14 py-16 sm:grid sm:grid-cols-2 sm:gap-12">
            ...
            <div className="flex flex-col gap-8 pt-16">
              <nav>
                <ul className="flex max-sm:flex-col items-center gap-4 text-text justify-end text-sm">
              ...
              <ul className="flex items-center gap-4 max-sm:justify-center sm:justify-end">
